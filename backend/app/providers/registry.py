...
PROVIDERS = (
    ...
    ProviderDefinition("awin", "Awin", None, "Rede de afiliados", ("promocoes", "feeds aprovados"), "O acesso depende da aprovacao da conta publisher e de cada anunciante.", "https://www.awin.com/br/", "awin"),
